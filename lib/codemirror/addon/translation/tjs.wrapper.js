...
(function(mod) {
  ...
  "use strict";
	const { youdao, baidu, google } = window.tjs
 	 CodeMirror.defineExtension("translate", function(mode, successCB, errorCB, options) {
     if (!mode) mode=0;
     ...
     if (mode==0){
                ...
                for(let i=0;i<linecount;i++){
                    ...
                    if(i>=(linecount-1))successCB(this);
                });
